...
#    graph = pd.read_csv(fn+"/"+fn+"_network.txt",sep=" ")## CHANDU: Updated
    attribute = open(fn.capitalize()+"/wc_"+fn+"_attribute.txt","w")
    ...
    f= open(fn.capitalize()+"/"+fn+"_incr_dic.json","w")
  ...
  #  graph.to_csv(fn+"/wc_"+fn+"_network_sample.txt",header=False,index=False, sep=" ")
