...
def store_samples(fn,cascade_nodes,cascade_times,initiators,train_set,op_time, user_gender_dictionary, N_males, N_females, sampling_perc=200):
    """
...
#     male_frac = len(male_list)  / ( len(male_list) +  len(female_list) )
    ...
    if s_times==0:
        ...
        samples = np.random.choice(a=cascade_nodes, size=int(no_samples*(fainess_score**5)), p=probs) 
